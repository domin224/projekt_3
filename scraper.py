...
def scrape_table(href, attributes):
    table_data = []
    soup = make_soup(href)
...
def scrape_site(href_list):
    ...
    for href in href_list:
        ...
        table_1 = scrape_table(href, {"data-rel": "L1"})
        href_data.extend(table_1)

        table_2 = scrape_table(href, {"headers": "t1sa2 t1sb3"})
        href_data.extend(table_2)

        table_3 = scrape_table(href, {"headers": "t2sa2 t2sb3"})
